...
<?php
 ...
 <?php if($link=="corrugated") { ?>
  <style type="text/css">
  .cke_editable {
    cursor: text;
    background: #b7722b !important;
}
...
<?php } ?>
  ...
  <div class="wrapsemibox" style="background:url('images/brown.jpg')">
      ...
      <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <div class="heading" style="text-transform: capitalize;">
              <i class="fa fa-image"></i> <?php echo $slug ?>
            </div>
   ...
   <textarea style="height: 900px;min-height: 900px" name="editor1"><?php echo $pagepost ?></textarea>
