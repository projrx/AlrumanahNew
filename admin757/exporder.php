      ...
      <div class="widget-container fluid-height clearfix overflow">
        ...
        <div class="widget-content padded clearfix">
          ...
          <tbody>
            ...
            <?php 
            $rows =mysqli_query($con,"SELECT * FROM shop where status='expired'  Order By id desc LIMIT $glimit  " ) or die(mysqli_error($con));
            ...
            while($row=mysqli_fetch_array($rows)){
              ...
              while($rowx=mysqli_fetch_array($rowsx)){
                ...
                <tr class="orow" onclick="window.location='exporders-<?php echo $oid ?>'">
