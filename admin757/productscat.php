                ...
                while($row=mysqli_fetch_array($rows)){
                  ...
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                          <img src="../images/products/<?php echo $img ?>"  style="width: 100px">
            ...
            <div class="widget-content padded clearfix">
              <table class="table table-bordered" style="border: none">
                                    ...
                                    <tr>
                                      ...
                                      <td>Name</td>
                                      <td>Parent </td>
                                      <td style="display:">Image </td>
                                      <td style="display:">New Image </td>
                                      <td>Order </td>
                                      <td> Action </td>
                                    </tr>
                                    <?php
                                 ...
                                 <?php } ?>
                                          ...
                                          <td  style="max-width: 100px; display:">
                                            <center>
                                          ...
                                          <td  style="max-width: 150px; display:">
                                            <center>
                                ...
                                <form method="post" action="" enctype="multipart/form-data">
                                 ...
                                 <?php } ?>
                                          ...
                                          <tr>
                                            ...
                                            <td  style="max-width: 60px;">
                                              <input required="" type="text" class="form-control" name="newordr" value="0">
                                            </td>
