...
<head>
  ...
  <?php if(empty( $_GET['page_name'])) $link = 'videos' ?>
  ...
  for ($i=0; $i < $ilimit ; $i++) { 
    ...
    if(isset($_POST['savecat'.$i])){
      ...
      if (!empty($_FILES['img'.$i]['name'])) {
        ...
        $target = "../images/videos/".basename($image);

        $data=mysqli_query($con,"UPDATE videoscat SET `img`='$image' where `id`='$id'")or die( mysqli_error($con) );
      ...
      $sql = "UPDATE videoscat SET `name` = '$name',`slug` = '$slug',`ordr` = '$ordr' WHERE `id` =$id";

      mysqli_query($con, $sql) ;
      ($msg=mysqli_error($con));
      if(empty($msg))  $msg="Updated";
      header("location:videos-$slug");
  ...
  for ($i=0; $i < $ilimit ; $i++) { 
    ...
    if(isset($_POST['delcat'.$i])){
      ...
      $sql = "DELETE FROM videoscat WHERE id=$id ";

      mysqli_query($con, $sql) ;

      $sql = "DELETE FROM videos WHERE catid=$id  ";
  ...
  $data=mysqli_query($con,"INSERT INTO videoscat (name,slug,img,ordr)VALUES ('$name','$slug','$image','$ordr')")or die( mysqli_error($con) );
  ...
  for ($i=0; $i < $ilimit ; $i++) { 
    ...
    if(isset($_POST['save'.$i])){
      ...
      if (!empty($_FILES['img'.$i]['name'])) {
        ...
        $data=mysqli_query($con,"UPDATE videos SET `img`='$image' where `id`='$id'")or die( mysqli_error($con) );
      ...
      $sql = "UPDATE videos SET `name` = '$name',`url` = '$url',`ordr` = '$ordr',`feat` = '$feat' WHERE `id` =$id";
  ...
  if(isset($_POST['add'])){
      ...
      $msg="Unsuccessful" ;
       ...
       $rows =mysqli_query($con,"SELECT id FROM videoscat where slug='$page'  ORDER BY ordr" ) or die(mysqli_error($con));
  ...
  $data=mysqli_query($con,"INSERT INTO videos (name,catid,catslug,url,img,ordr,feat)VALUES ('$name','$id','$page','$url','$image','$ordr','$feat')");

  ($msg=mysqli_error($con));

  if(empty($msg))  $msg="Not Done";
...
<body onload="showtoast()"  class="page-header-fixed bg-1 sidebar-nav">
  <div class="modal-shiftfix">
    ...
    <?php
    $rows =mysqli_query($con,"SELECT * FROM pages where slug='video' " ) or die(mysqli_error($con));
            ...
            <div class="container-fluid main-content">
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="widget-container fluid-height clearfix">
                    <div class="heading" style="text-transform: capitalize;">
                      <i class="fa fa-video"></i> <?php echo $page ?> Videos
                    </div>
                    <div class="widget-content padded clearfix">
                      <table class="table table-bordered">
                        <thead>
                      ...
                      <tbody>
                        ...
                        $rows =mysqli_query($con,"SELECT * FROM videos where catslug='$page'  ORDER BY ordr" ) or die(mysqli_error($con));
                        $n=0;
                        ...
                        while($row=mysqli_fetch_array($rows)){
                          ...
                          <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <tr>
                              ...
                              <td>
                                <textarea class="form-control" name="url<?php echo $n ?>" ><?php echo $url ?></textarea>
                              </td>
                              <td class="text-center">
                                <img style="max-height: 50px" src="../images/videos/<?php echo $img ?>" ?>
                              </td>
                              <td>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="clientModalL">Add New Video</h5>
                                      ...
                                      <div class="modal-body">
                                        <table>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <textarea name="newurl" class="form-control"></textarea>
                                            </td>
                                          </tr>
                                          <tr>
    ...
    <div class="container-fluid main-content">
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="widget-container fluid-height clearfix">
            <div class="heading">
              <i class="far fa-handshake"></i>Videos Category
            </div>
            <div class="widget-content padded clearfix">
              <table class="table table-bordered">
                <thead>
              ...
              <tbody>
                ...
                $rows =mysqli_query($con,"SELECT * FROM videoscat  ORDER BY ordr" ) or die(mysqli_error($con));
                $n=0;
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                          ...
                          <a href="videos-<?php echo $slug ?>" class="btn btn-primary-outline" value="<?php echo $id ?>"> </i> <i class="fa fa-plus"></i></a>
                      ...
                      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <form method="post" action="" enctype="multipart/form-data">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add New Videos Category</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
